var webContextModule = angular.module('imtposWebModule', []);

webContextModule.factory('Device', function() {
	return {
		getData: function() {
			return {
...
webContextModule.constant('WIMS_SERVERS', {
...
webContextModule.factory('ApiRequest', function($http, WIMS_SERVERS, Device, LocalStorage) {
	var TOKEN_KEY = 'token';
...
*/
webContextModule.factory('LocalStorage', function(){
	return {
		get: function(key) {
...
webContextModule.factory('Scan', function($state) {
	return {
...
Add NFC service
*/
webContextModule.factory('NFC', function() {
	return {
...
webContextModule.factory('Translations', function($state, ApiRequest) {
	var translations = {};
	return {
		getAll: function(language, cb) {
			...
			ApiRequest.webApiMethod('/External/GetWIMSResource', params, true, function(data) {
				translations = data.data;
				console.info('Translation List : ', translations);
